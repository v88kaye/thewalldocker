                    ...
                    if(comment_textarea.val() != ''){
                        ...
                        $.post(comment_form.attr('action'), comment_form.serialize(), function(comment_posted){
                            if(comment_posted)
                                ...
                                comment_textarea.siblings('.error_message').removeClass('hidden').text(comment_posted.message);
                        }, 'json');
                    }
                    else
...
<body>
    <div class="welcome">
        ...
        <form id="message_form" action="/post_message" method="POST">
            ...
            <textarea name="message" placeholder="Post Message" cols="30" rows="5"></textarea>    
...
<?php if(!empty($messages)){
    ...
    <?php   }
                ...
                <textarea class="comment" data-message-id="<?= $message['message_id'] ?>" cols="50" rows="4" placeholder="Write your comment"></textarea>
...
<?php    } ?>
        ...
        <form id="comment_form" class="hidden" action="/post_comment" method="POST">
            ...
            <input class="hidden" name="message_id"></form>
